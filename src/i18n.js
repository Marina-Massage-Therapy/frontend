        ...
        translation: {
          cmps: {
            ...
            homeTopSection: {
              ...
              subtitle:
                "Your journey to balance and tension release begins now.",
              read: "Read More",
            },
            newTestimonialCard: {
              hideForm: "HIDE FORM",
        ...
        translation: {
          cmps: {
            ...
            homeTopSection: {
              ...
              subtitle: "המסע שלך לאיזון ולשחרור מתח מתחיל כאן",
              read: "קרא עוד",
            },
            newTestimonialCard: {
              hideForm: "הסתר",
        ...
        translation: {
          cmps: {
            ...
            homeTopSection: {
              ...
              subtitle: "Ваш путь к снятию напряжения начинается прямо сейчас.",
              read: "Читать Далее",
            },
            newTestimonialCard: {
              hideForm: "СКРЫТЬ",
